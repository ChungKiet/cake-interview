...
type UserVoucherFunc func(context.Context, *ent.UserVoucherMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f UserVoucherFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.UserVoucherMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.UserVoucherMutation", m)
}
...
// The VoucherCampaignFunc type is an adapter to allow the use of ordinary
// function as VoucherCampaign mutator.
type VoucherCampaignFunc func(context.Context, *ent.VoucherCampaignMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f VoucherCampaignFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.VoucherCampaignMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.VoucherCampaignMutation", m)
}
