...
func (uc *UserCreate) check() error {
	...
	if _, ok := uc.mutation.PhoneNumer(); !ok {
		return &ValidationError{Name: "phone_numer", err: errors.New(`ent: missing required field "User.phone_numer"`)}
	}
	...
	if _, ok := uc.mutation.LatestLogin(); !ok {
		return &ValidationError{Name: "latest_login", err: errors.New(`ent: missing required field "User.latest_login"`)}
	}
	return nil
}
...
func (uc *UserCreate) createSpec() (*User, *sqlgraph.CreateSpec) {
	...
	if value, ok := uc.mutation.PhoneNumer(); ok {
		_spec.SetField(user.FieldPhoneNumer, field.TypeString, value)
		_node.PhoneNumer = &value
	}
	...
	if value, ok := uc.mutation.LatestLogin(); ok {
		_spec.SetField(user.FieldLatestLogin, field.TypeTime, value)
		_node.LatestLogin = value
	}
	return _node, _spec
}
