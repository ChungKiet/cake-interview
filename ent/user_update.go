...
func (uu *UserUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := uu.mutation.PhoneNumer(); ok {
	...
	if value, ok := uu.mutation.LatestLogin(); ok {
...
func (uuo *UserUpdateOne) sqlSave(ctx context.Context) (_node *User, err error) {
	...
	if value, ok := uuo.mutation.PhoneNumer(); ok {
		_spec.SetField(user.FieldPhoneNumer, field.TypeString, value)
	}
	...
	if value, ok := uuo.mutation.LatestLogin(); ok {
		_spec.SetField(user.FieldLatestLogin, field.TypeTime, value)
	}
